  ...
  return (
    <section className="max-w-6xl mx-auto px-4 py-10">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        ...
        <label htmlFor="ad-modal" className="btn btn-success">
          + Add Advertisement
        </label>
      </div>
      ...
      {/* ✅ Modal */}
      <input type="checkbox" id="ad-modal" className="modal-toggle" />
      <div className="modal bg-black bg-opacity-30 backdrop-blur-sm items-center justify-center">
        <div className="modal-box relative bg-white text-gray-800 border border-gray-200 shadow-lg w-11/12 max-w-md">
          <label htmlFor="ad-modal" className="btn btn-sm btn-circle absolute right-2 top-2">
            ✕
          </label>
      ...
      {/* ✅ Submitted Ads (Responsive Grid) */}
      <h3 className="text-xl font-semibold text-gray-700 mb-4 mt-10">
        Your Submitted Requests
      </h3>
