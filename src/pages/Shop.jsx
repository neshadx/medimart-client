...
const fallbackImage = "https://via.placeholder.com/48?text=No+Image";
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 py-10">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        ...
        <select
          className="w-full md:w-52 px-4 py-2 border border-gray-300 rounded-md text-gray-800 bg-white focus:outline-none focus:ring-2 focus:ring-green-500"
          value={sortOrder}
          onChange={(e) => setSortOrder(e.target.value)}
        >
          <option value="">Sort By Price</option>
      ...
      {isLoading ? (
        ...
        <div className="overflow-x-auto">
          <table className="table w-full min-w-[800px] border rounded-lg">
            <thead className="bg-green-100 text-black font-semibold">
              <tr>
                <th>#</th>
                <th>Image</th>
      ...
      {selectedMedicine && (
        <dialog id="shopModal" className="modal modal-open">
          <div className="modal-box bg-white text-gray-800 rounded-lg shadow-lg max-w-xs md:max-w-md mx-auto">
            <h3 className="text-xl md:text-2xl font-bold text-green-700 mb-4 text-center">
              {selectedMedicine.name}
            </h3>
            <div className="flex flex-col items-center mb-4">
              <img
            ...
            <div className="space-y-2 text-sm">
              ...
              <p>
                <strong>Rating:</strong> {selectedMedicine.rating ?? "-"}
              </p>
              <p>
                <strong>Stock:</strong> {selectedMedicine.stock ?? 0}
              </p>
              <p>
                <strong>Seller:</strong>{" "}
                {selectedMedicine.seller || selectedMedicine.company || "Unknown"}
